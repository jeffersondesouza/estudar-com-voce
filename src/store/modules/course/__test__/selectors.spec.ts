...
describe('Courses:SELECTORS', () => {
  ...
  const ALL_COURSES = [...CUSTOM, ...GENERIC_COURSES];

  describe('test:custom-courses', () => {

    it('sould receive a list of courses and retun custom', () => {

      expect(filterCustomCourses(ALL_COURSES)).toEqual(CUSTOM)
    });

  });

  describe('test:generic-courses', () => {

    it('sould receive a list of courses and retun generic', () => {

      expect(filterGenericCourses(ALL_COURSES)).toEqual(GENERIC_COURSES)
    });

  });

  describe('test:select course ', () => {

    it('sould receive a list of courses and retun a specifi course 1', () => {
      expect(selectCourse(1, ALL_COURSES)).toEqual(ALL_COURSES[0])
    });

    it('sould receive a list of courses and retun a specifi course 2', () => {
      expect(
