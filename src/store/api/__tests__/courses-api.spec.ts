...
describe('API:courses-api', () => {


  describe('when get all courses', () => {

    it('it should return a list of courses', () => {

      (axios.get as any).mockResolvedValue({ data: ResMock });
  ...
  describe('when get one course', () => {

    it('it should return a course', () => {

      (axios.get as any).mockResolvedValue({ data: ResMock[0] });

      expect.assertions(1);
      return api.loadCourse(1)
        .then(res => {
          expect(res).toEqual(ResMock[0]);
        })
    });
  ...
  describe('when get all courses abd fer error', () => {

    it('it should NOT return a list of courses', () => {
  ...
  describe('when get one course and ger an error', () => {

    it('it should NOT return a course', () => {
